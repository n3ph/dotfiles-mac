...
alias sed='gsed'
alias sound_jabra='SwitchAudioSource -t output -s "Jabra EVOLVE LINK" && SwitchAudioSource -t input -s "Jabra EVOLVE LINK"'
alias sound_external='SwitchAudioSource -t output -s "External Headphones" && SwitchAudioSource -t input -s "MacBook Pro Microphone"'
alias sound_internal='SwitchAudioSource -t output -s "MacBook Pro Speakers" && SwitchAudioSource -t input -s "MacBook Pro Microphone"'
alias tf='terraform'
alias tree='tree -C'
