...
alias sed='gsed'
alias sound_jabra_in='SwitchAudioSource -t input -s "Jabra EVOLVE LINK"'
alias sound_jabra_out='SwitchAudioSource -t output -s "Jabra EVOLVE LINK"'
alias sound_jack_in='SwitchAudioSource -t input -s "MacBook Pro Microphone"'
alias sound_jack_out='SwitchAudioSource -t output -s "External Headphones"'
alias tf='terraform'
alias tree='tree -C'
