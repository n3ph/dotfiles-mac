...
sudo scutil --set ComputerName "sparewheel"
sudo scutil --set HostName "sparewheel"
sudo scutil --set LocalHostName "sparewheel"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "sparewheel"
...
# Disable HTML mail viewing
defaults write com.apple.mail PreferPlainText -bool TRUE

# Set font sizes
defaults write com.apple.mail NSFontSize 13
defaults write com.apple.mail NSFixedPitchFontSize 13
